...
var host = "34.168.0.97";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "thisismypassword";  //password (change to match your db, yes this is very poor practice)
